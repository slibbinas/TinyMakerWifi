...
REGISTRAS = [
    ...
    ("Diegimas ir atnaujinimas", "https://github.com/slibbinas/TinyMakerResinLab#readme",
     "Parsisiunčia Resin Lab (privati repo, per gh prisijungimą) ir ūkį, perkuria nuorodas ir paleistį, perkrauna serverius.",
     "privati repo TinyMakerResinLab, scripts/dev/resin-lab/install.ps1",
     "PowerShell: gh api … install.ps1 | Set-Content …; powershell -File … (pilna komanda - README)", "Ne"),
