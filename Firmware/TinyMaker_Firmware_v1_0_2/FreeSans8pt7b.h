...
/**
 * @file FreeSans8pt7b.h
 * @brief GFX Font File: FreeSans 8pt
 *
 * This file contains the bitmap and glyph data for the FreeSans 8pt font.
 * It is used by the GFX library for text rendering on the display.
 *
 * Note: These files are typically generated by tools and should not be manually
 */
