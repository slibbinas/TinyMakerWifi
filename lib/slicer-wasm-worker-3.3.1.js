...
importScripts(BAZE + 'sla-web-3.3.1.js');
...
const paruostas = createSLA({ locateFile: function (p) { return BAZE + p.replace('sla-web.wasm', 'sla-web-3.3.1.wasm'); } }).then(function (m) {
  M = m;
