...
importScripts(BAZE + 'sla-web-3.0.6.js');
...
const paruostas = createSLA({ locateFile: function (p) { return BAZE + p.replace('sla-web.wasm', 'sla-web-3.0.6.wasm'); } }).then(function (m) {
  M = m;
