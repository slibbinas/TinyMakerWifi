 ...
 */
import * as BAZE from './slicer-core-3.0.1.js';
...
function darbininkas() {
   ...
   */
  const uzkrovejas =
    'self.SLA_VERSIJA="3.0.1";self.SLA_BAZE=' + JSON.stringify(ADRESAS) + ';' +
    'importScripts(' + JSON.stringify(ADRESAS + 'slicer-wasm-worker-3.0.1.js') + ');';
