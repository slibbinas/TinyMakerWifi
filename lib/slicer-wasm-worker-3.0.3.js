...
importScripts(BAZE + 'sla-web-3.0.3.js');
...
const paruostas = createSLA({ locateFile: function (p) { return BAZE + p.replace('sla-web.wasm', 'sla-web-3.0.3.wasm'); } }).then(function (m) {
  M = m;
