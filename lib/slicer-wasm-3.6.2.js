 ...
 */
import * as BAZE from './slicer-core-3.6.2.js';
 ...
 */
export const VERSION = '3.6.2-wasm';
...
const BAZES_FAILAS = 'slicer-core-3.6.2.js';
...
function naujasDarbininkas() {
  const uzkrovejas =
    'self.SLA_VERSIJA="3.6.2";self.SLA_BAZE=' + JSON.stringify(ADRESAS) + ';' +
    'importScripts(' + JSON.stringify(ADRESAS + 'slicer-wasm-worker-3.6.2.js') + ');';
