 ...
 */
import * as BAZE from './slicer-core-3.2.1.js';
...
const BAZES_FAILAS = 'slicer-core-3.2.1.js';
...
function darbininkas() {
   ...
   */
  const uzkrovejas =
    'self.SLA_VERSIJA="3.2.1";self.SLA_BAZE=' + JSON.stringify(ADRESAS) + ';' +
    'importScripts(' + JSON.stringify(ADRESAS + 'slicer-wasm-worker-3.2.1.js') + ');';
