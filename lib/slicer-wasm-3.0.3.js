 ...
 */
import * as BAZE from './slicer-core-3.0.3.js';

export const VERSION = '3.0.3-wasm';
...
function darbininkas() {
   ...
   */
  const uzkrovejas =
    'self.SLA_VERSIJA="3.0.3";self.SLA_BAZE=' + JSON.stringify(ADRESAS) + ';' +
    'importScripts(' + JSON.stringify(ADRESAS + 'slicer-wasm-worker-3.0.3.js') + ');';
