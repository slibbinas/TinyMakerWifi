...
export const SUP = {
  ...
  reachMm: 1.5,
  /* Set against PrusaSlicer's own count on ScreamingEvil, which it sliced for
     this printer: it carries 15–21 pillars at a time low down. At 4.5 mm we
     had 10–11 — fewer than the thing we are copying, which is the wrong side
     to err on. 3 mm brings us alongside it. */
