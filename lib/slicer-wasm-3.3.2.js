 ...
 */
import * as BAZE from './slicer-core-3.3.2.js';
...
const BAZES_FAILAS = 'slicer-core-3.3.2.js';
...
function darbininkas() {
   ...
   */
  const uzkrovejas =
    'self.SLA_VERSIJA="3.3.2";self.SLA_BAZE=' + JSON.stringify(ADRESAS) + ';' +
    'importScripts(' + JSON.stringify(ADRESAS + 'slicer-wasm-worker-3.3.2.js') + ');';
